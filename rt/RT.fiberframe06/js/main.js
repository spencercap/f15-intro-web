$( document ).ready(function() {
	...
	// FUNCTIONS
	function genPalette(image) {
		var colorThief = new ColorThief();
	    var color = colorThief.getColor( $stills[0] ); 
	    // console.log("color: " + color);
		var colors = colorThief.getPalette( $stills[0] , 8); // array of RGB (3) arrays // GET 8 swatches (second parameter)
		// console.log(palette);
		var palette_arr = [] ;
	...
	function setPalette( back, palette) { // primary, secondary, tertiary, 
		console.log(back);
		// console.log(primary);
	...
	// gen 
	console.log($stills[0]); // works
	var x = genPalette( $stills[0] );
	// console.log(x);
	
	// set 
	setPalette( $infoBacks[0] , x );
