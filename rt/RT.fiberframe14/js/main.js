$( document ).ready(function() {
	...
	$(".icon-search").on('click', function () {
		...
		$searchBar[0].style.left = "0vw" ;
	});
	/* --=-- search-CLOSE (nav) --=-- */
	$(".icon-search-close").on('click', function () {
		$searchBar[0].style.left = "100vw" ;
	...
	$(".user").on('click', function () {
		$(this).toggleClass("login-page-opened");
		var $containerLogin = $(".container-login");

		if ( $(this).hasClass("login-page-opened") ) {
